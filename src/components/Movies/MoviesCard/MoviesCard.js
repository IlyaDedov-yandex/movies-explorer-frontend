    ...
    return (
        <li className="movies-card">
            <div className="movies-card__info-container">
                ...
                <button className={isLiked ? `movies-card__btn movies-card__btn_type_liked` : `movies-card__btn movies-card__btn_type_disliked`} type="button" aria-label="Поставить лайк" onClick={handleLikeClick}></button>
            </div>
